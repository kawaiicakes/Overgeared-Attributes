...
import static io.github.kawaiicakes.overgeared_attributes.OvergearedAttributes.SMITHING_QUALITY;
...
public abstract class PlayerMixin {
    ...
    private static AttributeSupplier.Builder wrapAttributeSupplier(Operation<AttributeSupplier.Builder> original) {
        ...
        return original.call().add(SMITHING_DIFFICULTY.get()).add(SMITHING_QUALITY.get());
    }
}
